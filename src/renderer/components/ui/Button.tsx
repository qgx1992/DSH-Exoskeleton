 ...
 * 变体：primary 金实底 / secondary 次级 / ghost 幽灵 / danger 红 ghost / danger-solid 红实底（仅危险确认弹窗）/ success 绿 ghost / accent 金软底
 * 状态：default / hover / focus-visible(全局环) / active 下沉 1px / disabled 40% / loading 内联转圈
 */
import { forwardRef, type ButtonHTMLAttributes } from 'react'
import { IconSpinner } from './icons'

export type ButtonVariant = 'primary' | 'secondary' | 'ghost' | 'danger' | 'danger-solid' | 'success' | 'accent'
...
const VARIANTS: Record<ButtonVariant, string> = {
  ...
  'danger-solid': 'border-transparent bg-danger text-white hover:bg-danger/85',
